        ...
        <div>
            <Zoom>
                <Link to={`/categoryBooks/${category._id}`}>
                    <div className="hover:shadow-2xl hover:rounded-3xl hover:bg-cyan-300 text-center mb-2">
                        {/* <button className="btn btn-outline btn-info md:w-[200px] rounded-full md:text-lg text-white mb-4"> */}
                        <button className="">
                            {/* View Details */}
                            <div className="max-w-full md:h-[300px] lg:h-[400px]  rounded-3xl shadow-2xl flex flex-col items-center mb-10">
